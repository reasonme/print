...
@ConfigurationProperties(prefix = "summonsService", ignoreUnknownFields = false)
public class SummonsServiceProperties {
    ...
    public static class Swagger {
        private String title = "CuiBei OrganizationService API";

        private String description = "CuiBei OrganizationService documentation";
